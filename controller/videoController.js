...
// // 🛠️ HELPER: Get Video Duration using FFmpeg
...
//         // 1. Send Status via Socket: Processing
...
//         console.log(`✅ Success! Video Published: ${title}`);
        
//         // Response format changed to JSON for Axios
...
//         console.log("-----------------------------------------");
//         console.log("🟢 LIKE ATTEMPT | Video:", videoId, "| By User:", userId);

//         if (!userId) return res.status(401).json({ success: false, message: "Login required" });

//         const video = await Video.findById(videoId);
//         if (!video) {
//             console.log("❌ Error: Video not found in DB");
...
//             console.log("🎯 Target Recipient (Video Owner):", targetRecipient);

//             if (targetRecipient) {
//                 if (targetRecipient.toString() !== userId.toString()) {
...
//                 } else {
//                     console.log("ℹ️ Skipped: User liked their own video.");
//                 }
//             } else {
//                 console.log("⚠️ Warning: No uploader/owner found for this video.");
//             }
//         }
