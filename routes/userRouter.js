...
// 🛠️ FIX: isUser middleware ko import kiya
...
// ==========================================
// 1. PUBLIC ROUTES (Admin & User dono dekh sakte hain)
// ==========================================
router.get("/", userController.getHomePage);
...
// ==========================================
// 2. PROTECTED ROUTES (Sirf Logged In 'User' ke liye)
// ==========================================
// 🔥 Yahan isLoggedIn ke saath isUser lagaya hai taaki Admin access na kare

router.get("/profile", isLoggedIn, isUser, userController.getProfile);
router.get("/home", isLoggedIn, isUser, userController.renderHome || userController.getHomePage);

// --- Video Upload System ---
router.get("/upload-video", isLoggedIn, isUser, videoController.getUploadPage);
router.post(
  "/upload-video",
  isLoggedIn,
  isUser,
...
router.get("/subscriptions", isLoggedIn, isUser, userController.getUserSubs);

// ==========================================
// 🛠️ EDIT PROFILE
// ==========================================
router.get("/edit-profile", isLoggedIn, isUser, userController.getEditProfile);
router.post(
  "/update-profile",
  isLoggedIn,
  isUser,
...
// 🔐 CHANGE PASSWORD
// ==========================================
router.get("/change-password", isLoggedIn, isUser, userController.getChangePassword);
router.post(
  "/update-password",
  isLoggedIn,
  isUser,
...
// 🏦 BANK ACCOUNT SYSTEM
// ==========================================
router.get("/add-bank", isLoggedIn, isUser, userController.getAddBankPage);
router.post("/add-bank", isLoggedIn, isUser, userController.postAddBank);

// ==========================================
// 💰 WALLET, DEPOSIT & WITHDRAW SYSTEM
// ==========================================
router.get("/fundHistory", isLoggedIn, isUser, walletController.getFundHistory);
router.get("/deposit", isLoggedIn, isUser, walletController.getDepositPage);
router.post(
  "/deposit-finalize",
  isLoggedIn,
  isUser,
...
router.get("/withdraw-funds", isLoggedIn, isUser, walletController.getWithdrawPage);
router.post(
  "/withdraw-submit",
  isLoggedIn,
  isUser,
...
// 3. ACTION ROUTES
// ==========================================
router.post("/subscribe/:userId", isLoggedIn, isUser, userController.subscribeUser);
router.post("/shorts/like/:id", isLoggedIn, isUser, shortsController.likeShort);
...
router.get("/changePassword", (req, res) => res.redirect("/change-password"));
router.get("/addBankAccount", (req, res) => res.redirect("/add-bank"));
router.get('/packs', isLoggedIn, isUser, userController.getSubscriptionPacks);
