 ...
 * Purana route: router.get('/watch', ...) sirf "/watch" handle karta tha.
 * Naya route: "/watch/:id" dynamic ID handle karega (Jaise: /watch/69b841f0...)
 */
router.get('/watch/:id', videoController.getWatchPage || userController.getWatchPage);
// Backward compatibility ke liye (agar koi bina ID ke /watch par jaye)
...
router.post('/upload-video', isLoggedIn, upload.fields([
    { name: 'video', maxCount: 1 },
    { name: 'thumbnail', maxCount: 1 }
]), videoController.handleVideoUpload);

// Dashboard Logic
router.get('/dashboard', isLoggedIn, userController.getUserDashboard || ((req, res) => res.redirect('/profile')));
